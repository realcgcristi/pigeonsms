...
data class SpaceMemberDto(
    ...
    val last_online: Long? = null,
    val role: String,
    /** Custom role ids this member holds — the assign dialog pre-checks from this. */
...
data class BotCommandOptionDto(
    ...
    val choices: List<BotCommandChoiceDto> = emptyList(),
    val min: Double? = null,
    val max: Double? = null,
)

@Serializable
data class BotCommandChoiceDto(val name: String, val value: String)

/** The bot behind a command, as the command list returns it. */
@Serializable
data class CommandBotDto(
    val id: String,
    val user_id: String = "",
    val username: String = "",
    val display_name: String? = null,
...
@Serializable
data class ChannelCommandDto(
    val id: String,
    val bot: CommandBotDto,
    val name: String,
    val description: String = "",
    val options: List<BotCommandOptionDto> = emptyList(),
)

@Serializable data class ChannelCommandsResponse(val commands: List<ChannelCommandDto> = emptyList())

@Serializable
data class InteractionResponseDto(
    val interaction: JsonElement? = null,
